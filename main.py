...
#joblisting_manager.company_post_job_listing(111,14,"Python Developer","Description for PythonDEveloper position in Chennai","Chennai","300000","Full time")

#joblisting_manager.search_job_listings_by_salary_range(100000,400000)

jobapplication_manager=JobApplication(db_connector)

#jobapplication_manager.apply_for_job(161,104,54,"CoverLetter for Network Administrator position in Bangalore")
